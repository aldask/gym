...
export const gyms: gymContent[] = [
  ...
  },
  {
    ...
    description:
      "The new Vienuolis Iron GYM opens its doors on August 1! In this club, you will find the latest sports equipment, exercise machines, spacious functional and cardio areas with a view of the old town of Vilnius. We invite you to workout together with Iron GYM community – in 2 group training halls!",
  ...
  },
  {
    ...
    description:
      "You will find the newly renovated club in the PC Europa building, on the 3rd floor! Here you will find an exercise space for calm stretching, a wide functional area, and a group training room for real workout parties! You won’t feel crowded in the main exercise area either – it’s spacious, and there is enough exercise equipment for everyone. Don’t forget to capture your sports achievements next to the famous golden mirror in the functional area",
  ...
  },
  {
    ...
    description:
      "Antakalnis Iron Gym – a club close to your home! This is a club of like-minded people, where everyone knows each other! Here you will find an exercise space for quiet stretching, as well as a functional area. When you come to the hall, you won’t feel crowded either – it’s spacious, and there are enough exercise machines for everyone. You will be working out with modern equipment, tested and loved by professionals.",
    gymPerks:
